...
Source0: http://haproxy.1wt.eu/download/2.0/src/%{name}-%{version}.tar.gz
...
%build
%{__make} USE_PCRE=1 DEBUG="" ARCH=%{_target_cpu} TARGET=linux-glibc USE_OPENSSL=1 USE_ZLIB=1 USE_CPU_AFFINITY=1
